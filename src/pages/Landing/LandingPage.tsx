                            ...
                            <h4>
                                {parse(
                                    t.t(
                                        ...
                                        'Gewia is a learning platform created as part of the hackathon #WirVsVirus by the team <br><span>"The Morpheus Tutorials"</span>.<br>Gewia offers a learning platform for students who can work on tasks created by teachers.'
                                    )
                                )}
                            </h4>
                        </div>
