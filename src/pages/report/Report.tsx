...
import label from '../../components/task/difficulty/label/label';
...
class Report extends React.Component<ReportProps> {
    // TODO: Statemangment with mbox for info
    /* nullSubtrahend = '1';
        ...
        return (
            <div className="report-component text-dark">
                ...
                <div
                    ...
                    <text text={messages} distance="0.8rem" position="left" class="messages-count">
                        <Mail color="#3a506b"/>
                    </text>
                    <text text={teacher} distance="0.8rem" class="teacher-name">
